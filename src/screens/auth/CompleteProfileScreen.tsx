      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <Text style={styles.subtitle}>
            Signed in as {user?.email}. Tell us who you are to finish setting up your account.
          </Text>
          ...
          <TouchableOpacity onPress={() => logOut()} style={styles.linkBtn}>
            <Text style={styles.linkText}>Wrong account? <Text style={styles.linkTextBold}>Sign out</Text></Text>
          </TouchableOpacity>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
