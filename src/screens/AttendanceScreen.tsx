      ...
      <SafeAreaView style={styles.container} edges={["top"]}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor:
                overallPercentage >= REQUIRED_PERCENTAGE
                  ? colors.success
                  : colors.danger,
            },
          ]}
        >
          ...
          <Text style={styles.overallSub}>
            Requirement: {REQUIRED_PERCENTAGE}%
          </Text>
        </View>
              ...
              <View style={styles.card}>
                  ...
                  <View
                    style={[
                      styles.progressBarFill,
                      {
                        ...
                        backgroundColor: safe ? colors.success : colors.danger,
                      },
                    ]}
                  />
                </View>
                ...
                <View style={styles.actionRow}>
                  <TouchableOpacity
                    ...
                    onPress={() => markClass(item.id, true)}
                  >
                    <Ionicons
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => markClass(item.id, false)}
                  >
                    <Ionicons
