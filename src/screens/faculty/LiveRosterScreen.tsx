...
export default function LiveRosterScreen({
  sessionId,
  subject,
  onFinalized,
  onBack,
  ...
  const handleFinalize = () => {
    Alert.alert(
      "Finalize session",
      "This locks in attendance for all students. Continue?",
      [
                ...
                <View style={styles.actions}>
                  ...
                  >
                    <Ionicons
                      name="checkmark"
                      size={16}
                      color={isPresent ? "#fff" : colors.success}
                    />
                  </TouchableOpacity>
                  <TouchableOpacity
                  ...
                  >
                    <Ionicons
                      name="close"
                      size={16}
                      color={isAbsent ? "#fff" : colors.danger}
                    />
                  </TouchableOpacity>
                </View>
              </View>
